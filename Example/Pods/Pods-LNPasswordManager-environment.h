...
// LNPasswordManager
#define COCOAPODS_POD_AVAILABLE_LNPasswordManager
#define COCOAPODS_VERSION_MAJOR_LNPasswordManager 0
#define COCOAPODS_VERSION_MINOR_LNPasswordManager 1
#define COCOAPODS_VERSION_PATCH_LNPasswordManager 0
